Perfect — here's your **clean, professional `README.md`** with the requested sections removed and the **new feature (sales report + graphical insights)** added clearly.
